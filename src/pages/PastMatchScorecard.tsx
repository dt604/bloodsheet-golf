...
import { ArrowLeft, Flag, Receipt, Trash2, Edit2, Activity, Target, Zap, Droplets, Camera, CheckCircle2, AlertTriangle, ArrowRight, Banknote } from 'lucide-react';
        ...
        <div className="flex flex-col h-full bg-background font-sans overflow-y-auto overflow-x-hidden momentum-scroll pb-20 safe-bottom">
            ...
            <div className="flex-1 w-full flex flex-col pt-4">
                ...
                <div className="px-4 mt-3">
                    <div className="p-4 rounded-xl bg-surface/40 border border-borderColor/30 backdrop-blur-md relative overflow-hidden group">
                        {/* Background Decor */}
