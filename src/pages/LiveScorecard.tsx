                ...
                <div className="space-y-4">
                    ...
                    {players.map((player) => {
                        ...
                        return (
                            ...
                            >
                                <Card
                                    className={`p-4 transition-all duration-300 relative overflow-hidden ${isUnder ? 'border-neonGreen/40 bg-neonGreen/5' : 'border-borderColor/50'} ${!isMe ? (isUnder ? 'opacity-90' : 'opacity-70') : ''}`}
                                >
