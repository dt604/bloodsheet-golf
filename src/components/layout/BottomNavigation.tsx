...
export default function BottomNavigation() {
    ...
    const navItems = [
        ...
        { icon: HistoryIcon, label: 'Histories', path: '/history' },
    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 left-0 w-full z-40 pb-safe">
                <nav className="bg-[#1C1C1E]/85 backdrop-blur-2xl border-t border-white/10 px-4 py-2 shadow-[0_-10px_30px_rgba(0,0,0,0.5)]">
                    <div className="grid grid-cols-5 h-14 relative max-w-md mx-auto items-center">
                        ...
                        {/* Center FAB Slot - Occupies the middle column */}
