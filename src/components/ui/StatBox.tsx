...
export function StatBox({ label, value, valueColor = 'white', className, isAnimated, prefix, suffix }: StatBoxProps) {
    const colorClasses = {
    ...
    return (
        <Card className={cn('p-3 sm:p-4 flex flex-col items-center justify-center text-center overflow-hidden', className)}>
            ...
            <div className={cn('text-2xl sm:text-3xl font-black font-sans leading-none', colorClasses[valueColor])}>
